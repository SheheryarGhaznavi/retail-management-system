...
! function(e) {
    ...
    i = {
        ...
        findFileName: function(e) {
            var i = e.lastIndexOf("http://demo.interface.club/");
        ...
        _initTemplateDefaults: function() {
            var t, a, r, n, o, l, s, d, c, p, u, f, m, g, v, h, w, _, b, C, y, E, x, T, S, F, I, P, k, z, A, $, D, U, j, R = this;
        ...
        _readFiles: function(t) {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function(e, i) {
                ...
                var E, x, T, S, F, I, P, k, z, A, $ = g + e,
                    ...
                    O = "";
                if (h > 0)
                    for (S = 0; h > S; S++) k = v[S], z = r.msgFileTypes[k] || k, O += 0 === S ? z : ", " + z;
        ...
        _validateAllImages: function() {
            ...
            if (n === a.totalImagesCount && (a._raise("fileimagesloaded"), a.resizeImage))
                for (e = 0; e < a.loadedImages.length; e++) i = a.loadedImages[e], i.validated || (t = i.siz, t && o && t > 1e3 * o && a._getResizedImage(i, r, n), a.loadedImages[e].validated = !0)
        },
